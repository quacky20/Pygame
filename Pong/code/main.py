...
class Game():
    def __init__(self):
        ...
        # score
        try:
            with open(join('Pong','data', 'score.gamefile')) as score_file:
    ...
    def display_scores(self):
        ...
        player_rect = player_surf.get_frect(center = POS['player_score'])
        ...
        opponent_rect = opponent_surf.get_frect(center = POS['opponent_score'])
        self.display_surf.blit(opponent_surf,opponent_rect)
        
        # line separator
        pygame.draw.line(self.display_surf, COLORS['bg-detail'], (WINDOW_WIDTH / 2, 0), (WINDOW_WIDTH / 2, WINDOW_HEIGHT), 3)
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    self.running = False
                    with open(join('Pong','data', 'score.gamefile'), 'w') as score_file:
